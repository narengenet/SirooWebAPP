...
namespace SirooWebAPP.Infrastructure.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            ConstantDictionaries def_points_for_audio_like = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "def_points_for_audio_like", ConstantValue = "5", IsActive = true, Description = "امتیاز پیش فرض برای لایک پست صوتی", Created = DateTime.Now, CreatedBy = sina.Id, Category = "لایک ها", PriorityIndex = 17 };

            ConstantDictionaries def_points_for_client_registration = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "def_points_for_client_registration", ConstantValue = "100", IsActive = true, Description = "امتیاز اولیه برای کاربری که ثبت نام میکند.", Created = DateTime.Now, CreatedBy = sina.Id, Category = "ثبت نام", PriorityIndex = 18 };
            ConstantDictionaries def_points_for_client_invitation = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "def_points_for_client_invitation", ConstantValue = "50", IsActive = true, Description = "امتیاز برای معرف وقتی کاربر ثبت نام کرد.", Created = DateTime.Now, CreatedBy = sina.Id, Category = "ثبت نام", PriorityIndex = 19 };

            ConstantDictionaries store_default_credits_registration = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "store_def_credit_reg", ConstantValue = "0", IsActive = true, Description = "اعتبار اولیه فروشگاه برای ثبت نام اولین بار", Created = DateTime.Now, CreatedBy = sina.Id, Category = "فروشگاه", PriorityIndex = 20 };
            ConstantDictionaries store_point_usage_per_day = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "store_point_usage_per_day", ConstantValue = "-1", IsActive = true, Description = "تعداد دفعات استفاده از کارت تخفیف هر فروشگاه در روز برای یک مشتری", Created = DateTime.Now, CreatedBy = sina.Id, Category = "فروشگاه", PriorityIndex = 21 };
            ConstantDictionaries stores_max_donnation_point = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "stores_max_donnation_point", ConstantValue = "500", IsActive = true, Description = "حداکثر امتیازی که فروشگاه میتواند در هر نوتب هدیه بدهد", Created = DateTime.Now, CreatedBy = sina.Id, Category = "فروشگاه", PriorityIndex = 22 };
            ConstantDictionaries credit_for_client_registration_by_store_invitation = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "credit_for_client_registration_by_store_invitation", ConstantValue = "50", IsActive = true, Description = "اعتبار برای فروشنده ای که باعث ثبت نام مشتری شد", Created = DateTime.Now, CreatedBy = sina.Id, Category = "فروشگاه", PriorityIndex = 23 };

            ConstantDictionaries money_to_credit_ratio = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "money_to_credit_ratio", ConstantValue = "1000", IsActive = true, Description = "نسبت هر اعتبار به تومان", Created = DateTime.Now, CreatedBy = sina.Id, Category = "مالی", PriorityIndex = 24 };
            ConstantDictionaries def_percent_for_marketer = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "def_percent_for_marketer", ConstantValue = "10", IsActive = true, Description = "درصد بازاریاب", Created = DateTime.Now, CreatedBy = sina.Id, Category = "درصدها", PriorityIndex = 25 };

            ConstantDictionaries def_percent_for_zoneadmin = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "def_percent_for_zoneadmin", ConstantValue = "6", IsActive = true, Description = "درصد مدیر منطقه", Created = DateTime.Now, CreatedBy = sina.Id, Category = "درصدها", PriorityIndex = 26 };
            ConstantDictionaries def_percent_for_countryadmin = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "def_percent_for_countryadmin", ConstantValue = "4", IsActive = true, Description = "درصد مدیر مناطق", Created = DateTime.Now, CreatedBy = sina.Id, Category = "درصدها", PriorityIndex = 27 };
            ...
            ConstantDictionaries order_of_prize_payment_1 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "order_of_prize_payment_1", ConstantValue = "2,3,5", IsActive = true, Description = "ترتیب پرداخت کارمزدها نوع 1", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 33 };
            ConstantDictionaries maximum_number_of_prize_payment_1 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "maximum_number_of_prize_payment_1", ConstantValue = "1000", IsActive = true, Description = "حداکثر تعداد پرداخت کارمزدها نوع 1", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 34 };
            ConstantDictionaries expire_dates_for_ads_1 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "expire_dates_for_ads_1", ConstantValue = "20", IsActive = true, Description = "تعداد روزهای آگهی تجاری نوع 1", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 35 };

            ConstantDictionaries expire_dates_for_challenge_2 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "expire_dates_for_challenge_2", ConstantValue = "60", IsActive = true, Description = "تعداد روزهای مجاز برای چالش نوع 2", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 36 };
            ...
            ConstantDictionaries prize_for_invite_to_challenge_2 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "prize_for_invite_to_challenge_2", ConstantValue = "1000000", IsActive = true, Description = "کارمزد برای معرفی کاربران به چالش نوع 2", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 38 };
            ConstantDictionaries order_of_prize_payment_2 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "order_of_prize_payment_2", ConstantValue = "2,3,5", IsActive = true, Description = "ترتیب پرداخت کارمزدها نوع 2", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 39 };
            ConstantDictionaries maximum_number_of_prize_payment_2 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "maximum_number_of_prize_payment_2", ConstantValue = "1000", IsActive = true, Description = "حداکثر تعداد پرداخت کارمزدها نوع 2", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 40 };
            ConstantDictionaries expire_dates_for_ads_2 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "expire_dates_for_ads_2", ConstantValue = "20", IsActive = true, Description = "تعداد روزهای آگهی تجاری نوع 2", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 41 };

            ConstantDictionaries expire_dates_for_challenge_3 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "expire_dates_for_challenge_3", ConstantValue = "90", IsActive = true, Description = "تعداد روزهای مجاز برای چالش نوع 3", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 42 };
            ...
            ConstantDictionaries prize_for_invite_to_challenge_3 = new ConstantDictionaries { Id = Guid.NewGuid(), ConstantKey = "prize_for_invite_to_challenge_3", ConstantValue = "10000000", IsActive = true, Description = "کارمزد برای معرفی کاربران به چالش نوع 3", Created = DateTime.Now, CreatedBy = sina.Id, Category = "چالش", PriorityIndex = 44 };
            ...
            modelBuilder.Entity<ConstantDictionaries>().HasData(def_points_for_audio_like);
