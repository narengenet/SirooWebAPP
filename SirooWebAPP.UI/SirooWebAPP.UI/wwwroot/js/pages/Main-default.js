...
function _doLike(obj, adv) {
    ...
    if ($('.post.' + adv).hasClass('finished')) {
        ...
        alert('باید ویدئو/موزیک را تا انتها ملاحظه بفرمایید تا امتیاز لایک این ویدئو/موزیک را دریافت نمایید.');
    }
}
...
function showTags(theContainer, url) {
    ...
    if (image) {
        ...
        //document.getElementById(theContainer + '_image').style.display = "none";
    }
}
