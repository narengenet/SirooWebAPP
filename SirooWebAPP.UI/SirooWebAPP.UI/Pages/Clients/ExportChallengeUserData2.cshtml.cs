...
{
    public class ExportChallengeUserData2Model : PageModel
    {
        ...
        public ExportChallengeUserData2Model(CustomIDataProtection customIDataProtection, IUserServices services, IWebHostEnvironment environment)
        {
        ...
        public void OnGet()
        {
            ...
            if (_creatorId!= "17fb3917-9d6e-49f8-d0a0-08dac53d6445")
            {
                isValidUser = false;
            }
