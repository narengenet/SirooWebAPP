...
{
    public class InsuranceFourthModel : PageModel
    {

        private readonly IUserServices _usersServices;
        private readonly CustomIDataProtection protector;
        private readonly ISession session;
        public InsuranceFourthModel(CustomIDataProtection customIDataProtection, IUserServices services, IHttpContextAccessor httpContextAccessor)
        {
        ...
        void InitiateValidations()
        {
            ...
            neededMoney1 = Convert.ToInt32(_usersServices.GetConstantDictionary("money_needed_to_attend_in_insurance4").ConstantValue);
            ...
            if (theUser != null)
            {
                ...
                InsuranceFourthUserData _tmpInsuranceUserData = _usersServices.GetAllInsuranceFourthUserData().Where(x => x.User == theUser.Id).FirstOrDefault();
            ...
            if (HasHistory ^ ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if (parentRole.RoleName == "zoneadmin" || parentRole.RoleName == "marketer")
                    {
                        ...
                        InsuranceFourthUserData insuranceUserData = new InsuranceFourthUserData
                        {
                        ...
                        _usersServices.AddInsuranceFourthUserData(insuranceUserData);
                        ...
                        int prizeForMarketer = Convert.ToInt32(_usersServices.GetConstantDictionary("prize_marketer_to_invite_in_insurance4").ConstantValue);
                        int prizeForZoneadmin = Convert.ToInt32(_usersServices.GetConstantDictionary("prize_zoneadmin_to_invite_in_insurance4").ConstantValue);
