...
{
    public class InsuranceSndModel : PageModel
    {

        private readonly IUserServices _usersServices;
        private readonly CustomIDataProtection protector;
        private readonly ISession session;
        public InsuranceSndModel(CustomIDataProtection customIDataProtection, IUserServices services, IHttpContextAccessor httpContextAccessor)
        {
        ...
        [BindProperty]
        public AddInsuranceSecond? AddInsurance { get; set; }


        public AddInsuranceSecond preDefinedInsurance;
        ...
        void InitiateValidations()
        {
            ...
            neededMoney1 = Convert.ToInt32(_usersServices.GetConstantDictionary("money_needed_to_attend_in_insurance").ConstantValue);
            ...
            if (theUser != null)
            {
                ...
                InsuranceSecondUserData _tmpInsuranceUserData = _usersServices.GetAllInsuranceSecondUserData().Where(x => x.User == theUser.Id).FirstOrDefault();
                ...
                else
                {
                    ...
                    if (currentMoney >= neededMoney1)
                    {
                        ...
                        preDefinedInsurance = new AddInsuranceSecond();
        ...
        public IActionResult OnPostAddUserData(AddInsuranceSecond addInsurance)
        {
            InitiateValidations();
            ...
            if (HasHistory ^ ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if (parentRole.RoleName == "zoneadmin" || parentRole.RoleName == "marketer")
                    {
                        ...
                        InsuranceSecondUserData insuranceUserData = new InsuranceSecondUserData
                        {
                            ...
                            NationalIDPerson=addInsurance.TheNationalIDPerson,
                            FullNamePerson=addInsurance.TheFullNamePerson,
                            IsExported = false,
                            IsPaid = true,
                            User = theUser.Id,
                        ...
                        _usersServices.AddInsuranceSecondUserData(insuranceUserData);
